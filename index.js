...
for(let i = 0; i < cats.length; i++ ){
    ...
    div.innerText = cats[i].name
    document.getElementById("abc").appendChild(div)
    let img = document.createElement('img')
    img.src = cats[i].img_link
    img.className = "milka"
    document.getElementById("abc").appendChild(img)
    let age = document.createElement("div")
    age.innerText = cats[i].age
    document.getElementById("abc").appendChild(age)
    let rate = document.createElement("div")
    rate.innerText = cats[i].rate
    document.getElementById("abc").appendChild(rate)
    let favourite = document.createElement("div")
    favourite.innerText = cats[i].favourite
    document.getElementById("abc").appendChild(favourite)
    let description = document.createElement("div")
    description.innerText = cats[i].description
    document.getElementById("abc").appendChild(description)
    let idd = document.createElement('div')
    idd.innerText = cats[i].id
    document.getElementById("abc").appendChild(idd)
    let hr = document.createElement("hr")
    document.getElementById("abc").appendChild(hr)
...
box.style.fontFamily = "OCR A Std, monospace"
